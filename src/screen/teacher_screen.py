...
def teacher_tab_take_attendance():
    ...
    # Step 1: Teacher selects subject first
    ...
    with col2:
        # Step 2: Teacher clicks Add Photos button
    ...
    with c2:
        # Step 3: Teacher clicks Run Face Analysis button
        if st.button('Run Face Analysis', width='stretch', type='secondary', icon=':material/analytics:', disabled=not has_photos):
            with st.spinner('Deep scanning classroom photos...'):
                all_detected_ids = {}
                
                # Step 4: Process each uploaded photo
                for idx, img in enumerate(st.session_state.attendance_images):
                ...
                # Step 5: Fetch enrolled students from database
...
def teacher_screen_register():
    ...
    teacher_username = st.text_input("Enter Username", placeholder="username")
    teacher_name = st.text_input("Enter Full Name", placeholder="Full Name")
    teacher_password = st.text_input("Enter Password", placeholder="password", type='password')
    teacher_password_confirm = st.text_input("Confirm Password", placeholder="password", type='password')
